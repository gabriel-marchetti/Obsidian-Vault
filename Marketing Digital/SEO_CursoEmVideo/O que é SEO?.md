Acrônimo de uma sigle em inglês para Search Engine Optimization (Otimização para mecanismos de busca). Basicamente, se o Google entender que você é uma busca interessante, então ele vai te promover.
